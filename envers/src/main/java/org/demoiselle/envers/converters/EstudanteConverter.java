...
public class EstudanteConverter implements Converter {
	...
	private EstudanteDAO estudanteDAO = Beans.getReference(EstudanteDAO.class);
		...
		Object ret = null;
			if (component instanceof PickList) {
				...
				for (Object o : dl.getSource()) {
					String id = String.valueOf(((Estudante) o).getId());
					if (value.equals(id)) {
						ret = o;
						break;
					}
	...
	public String getAsString(FacesContext context, UIComponent component,
		...
		try{
			if (value == null || value.equals("")) {
				...
				return String.valueOf(((Estudante) value).getId());
			}
		}catch (Exception e) {
			e.printStackTrace();
			return "";
