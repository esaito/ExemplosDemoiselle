...
/**
 * TagLib para geracao de assinatura do tipo EnvelopingXML em ambiente servidor de aplicacao (WEB)
...
public class AssinaturaEnvelopingXmlWeb extends BodyTagSupport {
	
	private static final long serialVersionUID = -7861598251299753861L;
	...
	public String getConteudosArquivos() {
		return conteudosArquivos;
	}
	
	/**
	 * 
	 * @param conteudosArquivos -> Conteudo(s) do(s) arquivo(s) a ser(em) assinado(s), em base64,
	 * 	caso sejam mais de um, eles devem estar separados pelo conjunto de caracteres definidos no
	 *  separadorArquivo. 
	 */
	...
	private void drawScreenAssinatura(StringBuffer out){
		logger.info("TAGLIB DE ASSINATURA Enveloping XML WEB");
		...
		out.append("<object codebase=\"http://java.sun.com/update/1.6.0/jinstall-6-windows-i586.cab\" name=\"TabeliaoApplet\">\n")
				...
				.append("		acao=\"assinarEnvelopingXmlWeb\"\n")
