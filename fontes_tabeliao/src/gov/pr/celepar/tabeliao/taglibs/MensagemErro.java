...
/**
 * TagLib para formatacao e apresentacao das mensagens de ERRO para a validacao do certificado
 * @author Thiago Meneghello - GIC/CELEPAR
 *
 */
public class MensagemErro extends BodyTagSupport {
	
	private static Logger logger = Logger.getLogger(MensagemErro.class);
	...
	private void drawScreenMensagemAviso(StringBuffer out){
		...
		String mensagem = (String)servletRequest.getAttribute(Constants.TABELIAO_MENSAGEM_ERRO);
